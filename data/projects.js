...
const eduwalletHero = '/assets/projects/eduwallet/thishero.png'
const eduwalletHero1 = '/assets/projects/eduwallet/hero1.png'
const eduwalletShot2 = '/assets/projects/eduwallet/Screenshot_2026-09-03_190708.png'
const eduwalletShot3 = '/assets/projects/eduwallet/Screenshot_2026-09-03_190746.png'
const eduwalletShot4 = '/assets/projects/eduwallet/Screenshot_2026-09-03_193434.png'
const eduwalletShot5 = '/assets/projects/eduwallet/Screenshot_2026-09-03_194853.png'
const eduwalletShot6 = '/assets/projects/eduwallet/Screenshot_2026-09-03_201401.png'
const eduwalletShot7 = '/assets/projects/eduwallet/Screenshot_2026-09-03_201733.png'
const eduwalletShot8 = '/assets/projects/eduwallet/Screenshot_2026-09-03_222527.png'
const eduwalletShot9 = '/assets/projects/eduwallet/Screenshot_2026-09-03_225817.png'
const eduwalletShot10 = '/assets/projects/eduwallet/Screenshot_2026-09-07_143313.png'
const eduwalletShot11 = '/assets/projects/eduwallet/Screenshot_2026-09-07_143534.png'
const eduwalletShot12 = '/assets/projects/eduwallet/Screenshot_2026-09-07_165300.png'
const eduwalletShot13 = '/assets/projects/eduwallet/Screenshot_2026-09-07_170000.png'
const eduwalletShot14 = '/assets/projects/eduwallet/Screenshot_2026-09-07_205600.png'
const eduwalletShot15 = '/assets/projects/eduwallet/Screenshot_2026-09-07_212616.png'
const eduwalletShot16 = '/assets/projects/eduwallet/Screenshot_2026-09-08_145550.png'
const eduwalletShot17 = '/assets/projects/eduwallet/Screenshot_2026-09-08_150051.png'
...
export const gradientMap = {
  eduwallet: 'from-blue-500 to-indigo-800',
...
export const projects = [
  {
    ...
    year: '2026',
    description:
      "Fintech digital wallet built for educational platforms, enabling students to manage tuition payments, balances, and transactions. Master's thesis project.",
    impact:
    ...
    highlights: [
      'Built a full-stack fintech wallet platform for student tuition payments, balances, and transactions',
      'Cross-platform delivery with a Next.js web app and a React Native mobile app sharing the same backend',
      'RESTful API and data layer built with NestJS, TypeScript, Prisma, and Supabase',
      'Responsive, animated UI with Tailwind CSS v4, shadcn/ui, and Framer Motion',
      "Designed and built solo as the centerpiece deliverable for a Master's thesis on education-focused fintech",
    ],
    learned: [
      'Designing a fintech-style wallet system spanning both web and mobile clients',
      'Structuring a NestJS, Prisma, and Supabase backend for financial transaction data',
      'Building cross-platform UI with Next.js and React Native from a shared architecture',
  ...
  },
  {
    ...
    impact:
      'Shipped the customer-facing dashboard for a live client platform  booking workflows, payments, reservations, and profile management used by real marina customers.',
    stack: [
      'NestJS',
      'Next.js',
      'TypeScript',
  ...
  },
  {
    ...
    impact:
      'Built for a working Lebanese taxi driver to replace manual phone booking, handling reservations conversationally in Arabic, English, and French.',
    stack: [
      'Python',
      'FastAPI',
      'Groq LLM',
