...
const skills = [
  ...
  { name: 'Fastify', category: 'Backend', icon: SiFastify, neutral: true },
  { name: 'JWT', category: 'Backend', icon: SiJsonwebtokens, neutral: true },
  ...
  { name: 'Expo', category: 'Frontend', icon: SiExpo, neutral: true },
  ...
  { name: 'Claude', category: 'AI & Tools', icon: ClaudeIcon, color: '#D97706' },
